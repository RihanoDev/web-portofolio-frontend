<template>
  <div class="relative z-50" ref="dropdownRef">
    ...
    <button 
      @click="isOpen = !isOpen"
      class="relative overflow-hidden group flex items-center space-x-2 px-3 py-2 rounded-lg hover:scale-105 transition-all duration-300 focus:outline-none lang-selector-btn"
    ...
    >
      <div 
        v-if="isOpen"
        class="absolute right-0 mt-2 w-48 rounded-xl shadow-lg z-[9999] overflow-hidden mobile-dropdown lang-dropdown"
      >
        <div class="p-2">
